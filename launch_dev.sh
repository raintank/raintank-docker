...
screen -S raintank -p nsq_metrics_to_kairos -X stuff './nsq_metrics_to_kairos --kairos-addr kairosdb:8080 --statsd-addr statsdaemon:8125 --nsqd-tcp-address nsqd:4150 &> /var/log/raintank/nsq_metrics_to_kairos.log &\n'
screen -S raintank -p nsq_metrics_to_kairos -X stuff 'tail -f /var/log/raintank/nsq_metrics_to_kairos.log\n'
