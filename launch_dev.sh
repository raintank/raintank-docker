...
screen -S raintank -p nsq_metrics_tank -X stuff './nsq_metrics_tank --statsd-addr statsdaemon:8125 --nsqd-tcp-address nsqd:4150 --numchunks 5 --chunkspan 120 --listen :6063 --channel tank-5-120 --instance 5-120 &> /var/log/raintank/nsq_metrics_tank.log-5-120 &\n'
screen -S raintank -p nsq_metrics_tank -X stuff './nsq_metrics_tank --statsd-addr statsdaemon:8125 --nsqd-tcp-address nsqd:4150 --numchunks 6 --chunkspan 3600 --listen :6064 --channel tank-6-3600 --instance 6-3600 &> /var/log/raintank/nsq_metrics_tank.log-6-3600 &\n'
