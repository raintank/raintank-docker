...
screen -S raintank -p nsq_metrics_to_kairos -X stuff './nsq_metrics_to_kairos --statsd-addr statsdaemon:8125 --nsqd-tcp-address nsqd:4150 2>&1 | tee /var/log/raintank/nsq_metrics_to_kairos.log\n'
...
screen -S raintank -p nsq_metrics_to_elasticsearch -X stuff './nsq_metrics_to_elasticsearch --statsd-addr statsdaemon:8125 --nsqd-tcp-address nsqd:4150\n'
...
screen -S raintank -p nsq_probe_events_to_elasticsearch -X stuff './nsq_probe_events_to_elasticsearch --statsd-addr statsdaemon:8125 --nsqd-tcp-address nsqd:4150\n'
