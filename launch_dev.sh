...
screen -S raintank -p nsq_metrics_tank -X stuff './nsq_metrics_tank --statsd-addr statsdaemon:8125 --nsqd-tcp-address nsqd:4150 2>&1 | tee /var/log/raintank/nsq_metrics_tank.log\n'
